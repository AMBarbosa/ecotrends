...
Note that (if you have `fuzzySim` >= 4.25 installed) you can add a `bias` layer to drive the selection of background points, if your study area contains more pixels than `nbg`. See the `?getModels` help file for more details.
