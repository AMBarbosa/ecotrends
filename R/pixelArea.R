#' Pixel area
#'
#' @param r SpatRaster for which to compute the pixel area
...
#' @param mask logical value (default TRUE) indicating whether to include only the areas of non-NA pixels
#' @param map logical value (default TRUE) indicating whether to plot a map
#'
